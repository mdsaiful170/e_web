...
<body>
   ...
   <section class="checkout-orders wow animate__zoomIn">
      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="text" name="flat" placeholder="area name" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>address line 02 :</span>
               <input type="text" name="street" placeholder="address name" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>city :</span>
